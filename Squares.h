//
// Created by Joe Chrisman on 9/27/22.
//

#ifndef DEEPENING1_SQUARES_H
#define DEEPENING1_SQUARES_H
...
// non-inlined square related functions go in the squares namespace
namespace squares
{
    std::string toNotation(Square square);
    std::string toNotation(const Move &move);
    Square toSquare(const std::string &notation);
}
...
// still unused... TODO: delete maybe
